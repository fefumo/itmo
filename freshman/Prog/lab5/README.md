...
В интерактивном режиме программа должна поддерживать выполнение следующих команд:
    ...
    min_by_number_of_participants : вывести объект из коллекции, значение поля numberOfParticipants которого является минимальным
    group_counting_by_id id : вывести количество элементов, значение поля id которых меньше заданного
