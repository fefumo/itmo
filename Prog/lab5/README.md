...
В интерактивном режиме программа должна поддерживать выполнение следующих команд:
    ...
    history : вывести последние 14 выполненных комманд
    min_by_number_of_participants : вывести любой объект из коллекции, значение поля numberOfParticipants которого является минимальным
    group_counting_by_id : вывести количество элементов, значение поля id которых меньше заданного
